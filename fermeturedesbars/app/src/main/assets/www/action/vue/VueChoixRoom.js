  ...
  return function (envoyerCreationRoom) {
    ...
    this.afficherListeRoom = function (listeRoom) {
      ...
      for (i = 0; i < listeRoom.length; i++) {
        ...
        document.getElementById('listeRoom').innerHTML += "<tr><th class='text-left'>"+i+"</th><th class='text-left'><a id='RoomElement' class='elementRoom' href='#attente-multijoueur/"+listeRoom[i].id+"'>"+listeRoom[i].nom+"</a></th></tr>";
