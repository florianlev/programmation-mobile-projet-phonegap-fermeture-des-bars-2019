  ...
  return function (envoyerCreationRoom) {
    ...
    this.afficherListeRoom = function (listeRoom) {
      ...
      for (i = 0; i < listeRoom.length; i++) {
        ...
        document.getElementById('listeRoom').innerHTML += "<tr><th class='text-left'>"+i+"</th><th class='text-left'><a id='"+listeRoom[i].id+"' class='elementRoom' href='#attente-multijoueur'>"+listeRoom[i].nom+"</a></th></tr>";
